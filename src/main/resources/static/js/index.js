function loadAndDisplayUsers() {
    ...
    fetch('https://conversessionapp-production.up.railway.app/api/v1/users')
        .then((response) => {
...
function handleLogout() {
    fetch('https://conversessionapp-production.up.railway.app/api/v1/users/logout', {
        method: 'POST',
        headers: {
...
document.getElementById("deleteBtn").addEventListener("click", function() {
    window.location.href = "delete.html"; // Redirect to the deleteUser.html file
});

document.getElementById("updateBtn").addEventListener("click", function() {
    window.location.href = "update.html"; // Redirect to the deleteUser.html file
});
